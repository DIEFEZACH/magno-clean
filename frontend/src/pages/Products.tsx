...
export function Products(){
  ...
  return <><Seo title={seoTitle} description={seoDescription} path={category?`/productos?category=${encodeURIComponent(category)}`:"/productos"}/><section className="bg-[#F5F5F5] px-5 py-20 lg:px-8"><div className="mx-auto max-w-7xl">
    <div className="mb-10"><p className="mb-3 text-sm font-black uppercase tracking-[0.25em] text-[#19A2B6]">Catálogo</p><h1 className="text-5xl font-black tracking-[-0.05em] md:text-7xl">Productos Magno Clean</h1><p className="mt-5 max-w-2xl text-lg leading-8 text-black/60">Explora nuestra línea de soluciones para limpieza residencial, comercial e industrial.</p></div>
