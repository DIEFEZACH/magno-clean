...
export type CatalogVariant = { id: string; slug: string; code: string; name: string; description: string; label: string; sortOrder: number; price: number; oldPrice: number | null; imageUrl: string | null; images: CatalogImage[]; badge: string | null; available: boolean; availableStock: number };
...
export type CatalogDetailResponse = { item: CatalogItem; selectedVariantId: string | null; canonicalSlug: string };
