...
export type PublicWebsiteContentMedia = { role: PublicWebsiteContentMediaRole; url: string; alt: string; position: number; width: number; height: number };
export type PublicWebsiteContent = { media: PublicWebsiteContentMedia[] };
...
export type CatalogDetailResponse = { item: CatalogItem; selectedVariantId: string | null; canonicalSlug: string; websiteContent: PublicWebsiteContent | null };
